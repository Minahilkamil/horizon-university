      ...
      <section className="relative pt-32 pb-24 overflow-hidden bg-gray-900">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <p className="text-lg md:text-xl text-white/60 max-w-2xl leading-relaxed">
            Articles, guides, and stories from our students, faculty, and alumni community.
          </p>
        </div>
      </section>
              ...
              <Link href={`/blog/${post.slug}`} key={post.id} className="group">
                <div className="rounded-3xl overflow-hidden h-full bg-gray-50 border border-gray-200">
                  ...
                  <div className="p-7">
                    ...
                    <h3 className="text-base font-bold mb-3 text-gray-900">{post.title}</h3>
                    <p className="text-sm leading-relaxed mb-4 text-gray-600">{post.excerpt}</p>
